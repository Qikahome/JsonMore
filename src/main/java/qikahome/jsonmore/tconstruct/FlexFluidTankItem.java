...
public class FlexFluidTankItem extends TankItem implements IEventRunner
{ 
    public FlexFluidTankItem(RegistryObject<Block> block, boolean useBlockName, Properties properties, boolean limitStackSize, ItemBuilder builder)
    {
        super(null,properties, limitStackSize);
