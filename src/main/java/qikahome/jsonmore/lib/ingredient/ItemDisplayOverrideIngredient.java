...
public class ItemDisplayOverrideIngredient extends SelfConsumingIngredient {
    ...
    private record RemoveHandler(Ingredient toRemove) implements IOpHandler {
        ...
        @Override
        public void toJson(JsonObject out) {
            out.add("value", toRemove.toJson());
        }
    }
    ...
    public static class Serializer implements CustomIngredientSerializer<ItemDisplayOverrideIngredient> {
        ...
        @Override
        public ItemDisplayOverrideIngredient read(FriendlyByteBuf buffer) {
        ...
        @Override
        public ItemDisplayOverrideIngredient read(JsonObject json) {
        ...
        @Override
        public void write(JsonObject json, ItemDisplayOverrideIngredient ingredient) {
            ...
            for (OpEntry op : ingredient.ops) {
                ...
                if (op.filter != null)
                    obj.add("filter", op.filter.toJson());
