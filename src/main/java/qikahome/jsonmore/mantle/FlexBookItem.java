...
public class FlexBookItem extends AbstractBookItem implements IEventRunner {

    public FlexBookItem(Properties properties, ItemBuilder builder, BookData bookData) {
        super(properties);
        this.book = bookData;
