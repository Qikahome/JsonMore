...
public class FlexRecordItem extends RecordItem implements IEventRunner{

    public FlexRecordItem(ItemBuilder builder, int comparatorValue, Supplier<SoundEvent> soundSupplier, Properties properties, int lengthInTicks)
    {
